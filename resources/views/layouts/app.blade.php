...
<body>
    ...
    <div class="fixed bottom-0 left-0 right-0 bg-yeng-pink-500 shadow-lg p-2 m-6 flex justify-between items-center border-t border-gray-200 z-50 rounded-full">
        <button onclick="loadView('home', this)" class="nav-button transition duration-300 rounded-full h-16 w-16 flex justify-center items-center">
            <img src="/images/House.svg" alt="Home" class="h-8 w-8">
        </button>
        <button onclick="loadView('book', this)" class="nav-button transition duration-300 rounded-full h-16 w-16 flex justify-center items-center">
            <img src="/images/Plus.svg" alt="Plus" class="h-8 w-8">
        </button>
        <button onclick="loadView('calendar', this)" class="nav-button transition duration-300 rounded-full h-16 w-16 flex justify-center items-center">
            <img src="/images/calendar.svg" alt="Sessions" class="h-8 w-8">
        </button>
        <button onclick="loadView('profile', this)" class="nav-button transition duration-300 rounded-full h-16 w-16 flex justify-center items-center">
